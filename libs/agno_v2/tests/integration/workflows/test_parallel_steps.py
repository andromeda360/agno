...
from agno_v2.run.workflow import WorkflowCompletedEvent, WorkflowRunOutput
from agno_v2.workflow import Workflow
...
def test_parallel_direct_execute_stream():
    ...
    from agno_v2.run.workflow import ParallelExecutionCompletedEvent, ParallelExecutionStartedEvent, WorkflowRunOutput
