...
from agno_v2.knowledge.knowledge import ContentStatus, Knowledge
from agno_v2.os.routers.knowledge.knowledge import attach_routes
...
async def test_process_content_success(mock_knowledge, mock_content):
    ...
    from agno_v2.os.routers.knowledge.knowledge import process_content
