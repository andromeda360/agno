...
from agno_v2.os.interfaces.agui.utils import EventBuffer, async_stream_agno_response_as_agui_events
from agno_v2.run.agent import RunContentEvent, ToolCallCompletedEvent, ToolCallStartedEvent
...
def test_validate_agui_state_with_valid_dict():
    ...
    from agno_v2.os.interfaces.agui.utils import validate_agui_state
