...
from agno_v2.run.base import BaseRunOutputEvent
from agno_v2.run.workflow import BaseWorkflowRunOutputEvent
...
def test_agent_session_state_in_completed_event():
    ...
    from agno_v2.run.agent import RunOutput
    from agno_v2.utils.events import create_run_completed_event
...
def test_team_session_state_in_completed_event():
    ...
    from agno_v2.run.team import TeamRunOutput
    from agno_v2.utils.events import create_team_run_completed_event
...
def test_api_schema_session_state():
    ...
    from agno_v2.os.schema import RunSchema, TeamRunSchema
    from agno_v2.run.agent import RunOutput
    from agno_v2.run.team import TeamRunOutput
