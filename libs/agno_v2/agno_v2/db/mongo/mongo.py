...
<<<<<<< HEAD:libs/agno_v2/agno_v2/db/mongo/mongo.py
...
>>>>>>> origin/main:libs/agno/agno/db/mongo/mongo.py
    apply_pagination,
    apply_sorting,
    bulk_upsert_metrics,
...
from agno_v2.db.utils import deserialize_session_json_fields
from agno_v2.session import AgentSession, Session, TeamSession, WorkflowSession
...
class MongoDb(BaseDb):
    def __init__(
        ...
        if id is None:
            ...
            db_name_suffix = db_name if db_name is not None else "agno_v2"
        ...
        self.db_name: str = db_name if db_name is not None else "agno_v2"
    ...
    def migrate_table_from_v1_to_v2(self, v1_db_schema: str, v1_table_name: str, v1_table_type: str):
        ...
        from agno_v2.db.migrations.v1_to_v2 import (
