...
from agno_v2.models.response import ModelResponse, ModelResponseEvent
...
from agno_v2.utils.print_response.team import (
    aprint_response,
...
from agno_v2.utils.team import (
...
class Team:
        ...
        try:
            ...
            if self.output_model is None:
                ...
                for event in self._handle_model_response_stream(
                    ...
                    raise_if_cancelled(run_response.run_id)  # type: ignore
                    from agno_v2.run.team import IntermediateRunContentEvent, RunContentEvent
    ...
    def _reason(
        ...
        if use_default_reasoning:
            ...
            from agno_v2.reasoning.helpers import get_next_action, update_messages_with_reasoning
    ...
    def _get_messages_for_parser_model(
        ...
        from agno_v2.utils.prompts import get_json_output_prompt
    ...
    def _log_team_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from agno_v2.api.team import TeamRunCreate, create_team_run
    ...
    async def _alog_team_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from agno_v2.api.team import TeamRunCreate, acreate_team_run
