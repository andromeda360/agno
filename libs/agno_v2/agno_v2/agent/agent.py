...
<<<<<<< HEAD:libs/agno_v2/agno_v2/agent/agent.py
from agno_v2.culture.manager import CultureManager
...
>>>>>>> origin/main:libs/agno/agno/agent/agent.py
    InputCheckError,
    ModelProviderError,
    OutputCheckError,
...
from agno_v2.models.message import Message, MessageReferences
from agno_v2.models.metrics import Metrics
from agno_v2.models.response import ModelResponse, ModelResponseEvent, ToolExecution
...
from agno_v2.session import AgentSession, SessionSummaryManager, TeamSession, WorkflowSession
...
from agno_v2.utils.message import filter_tool_calls, get_text_from_message
from agno_v2.utils.print_response.agent import (
    aprint_response,
    aprint_response_stream,
    print_response,
    print_response_stream,
)
from agno_v2.utils.prompts import get_json_output_prompt, get_response_model_format_prompt
from agno_v2.utils.reasoning import (
...
from agno_v2.utils.response import (
    async_generator_wrapper,
    generator_wrapper,
    get_paused_content,
)
from agno_v2.utils.safe_formatter import SafeFormatter
from agno_v2.utils.string import generate_id_from_name, parse_response_model_str
...
>>>>>>> origin/main:libs/agno/agno/agent/agent.py
    ...
    def _handle_model_response_chunk(
        ...
        from agno_v2.run.workflow import WorkflowRunOutputEvent
    ...
    def get_system_message(
        ...
        if self.add_location_to_context:
            from agno_v2.utils.location import get_location
    ...
    def _reason(
        ...
        if reasoning_model_provided:
            from agno_v2.reasoning.anthropic import is_anthropic_reasoning_model
            from agno_v2.reasoning.azure_ai_foundry import is_ai_foundry_reasoning_model
            from agno_v2.reasoning.deepseek import is_deepseek_reasoning_model
            from agno_v2.reasoning.gemini import is_gemini_reasoning_model
            from agno_v2.reasoning.groq import is_groq_reasoning_model
            from agno_v2.reasoning.helpers import get_reasoning_agent
            from agno_v2.reasoning.ollama import is_ollama_reasoning_model
            from agno_v2.reasoning.openai import is_openai_reasoning_model
            from agno_v2.reasoning.vertexai import is_vertexai_reasoning_model
            ...
            if (
                ...
                if is_deepseek:
                    from agno_v2.reasoning.deepseek import get_deepseek_reasoning
                    ...
                    from agno_v2.reasoning.groq import get_groq_reasoning
                    ...
                    from agno_v2.reasoning.openai import get_openai_reasoning
                    ...
                    from agno_v2.reasoning.ollama import get_ollama_reasoning
                    ...
                    from agno_v2.reasoning.azure_ai_foundry import get_ai_foundry_reasoning
                    ...
                    from agno_v2.reasoning.gemini import get_gemini_reasoning
                    ...
                    from agno_v2.reasoning.anthropic import get_anthropic_reasoning
                    ...
                    from agno_v2.reasoning.vertexai import get_vertexai_reasoning
        ...
        if use_default_reasoning:
            from agno_v2.reasoning.default import get_default_reasoning_agent
            from agno_v2.reasoning.helpers import (
                get_next_action,
    ...
    async def _areason(
        ...
        if reasoning_model_provided:
            ...
            if (
                ...
                reasoning_message: Optional[Message] = None
                if is_deepseek:
                    from agno_v2.reasoning.deepseek import aget_deepseek_reasoning
                    ...
                    from agno_v2.reasoning.groq import aget_groq_reasoning
                    ...
                    from agno_v2.reasoning.openai import aget_openai_reasoning
                    ...
                    from agno_v2.reasoning.gemini import aget_gemini_reasoning
                    ...
                    from agno_v2.reasoning.anthropic import aget_anthropic_reasoning
                    ...
                    from agno_v2.reasoning.vertexai import aget_vertexai_reasoning
    ...
    def _log_agent_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from agno_v2.api.agent import AgentRunCreate, create_agent_run
    ...
    async def _alog_agent_telemetry(self, session_id: str, run_id: Optional[str] = None) -> None:
        ...
        from agno_v2.api.agent import AgentRunCreate, acreate_agent_run
