...
from agno_v2.os.interfaces.base import BaseInterface
from agno_v2.os.router import get_base_router, get_websocket_router
from agno_v2.os.routers.evals import get_eval_router
from agno_v2.os.routers.health import get_health_router
from agno_v2.os.routers.home import get_home_router
from agno_v2.os.routers.knowledge import get_knowledge_router
from agno_v2.os.routers.memory import get_memory_router
from agno_v2.os.routers.metrics import get_metrics_router
from agno_v2.os.routers.session import get_session_router
from agno_v2.os.routers.traces import get_traces_router
from agno_v2.os.settings import AgnoAPISettings
...
from agno_v2.utils.string import generate_id, generate_id_from_name
...
class AgentOS:
    def __init__(
        ...
        if self.telemetry:
            from agno_v2.api.os import OSLaunch, log_os_telemetry
    ...
    def resync(self, app: FastAPI) -> None:
        ...
        if self.enable_mcp_server:
            from agno_v2.os.mcp import get_mcp_server
    ...
    def _add_built_in_routes(self, app: FastAPI) -> None:
        ...
        if self.a2a_interface and not has_a2a_interface:
            from agno_v2.os.interfaces.a2a import A2A
    ...
    def serve(
        ...
        **kwargs,
        ...
        if getenv("AGNO_V2_V2_API_RUNTIME", "").lower() == "stg":
