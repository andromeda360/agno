...
class ChunkingStrategyFactory:
    ...
    def _create_agentic_chunking(
        ...
        from agno_v2.knowledge.chunking.agentic import AgenticChunking
    ...
    def _create_recursive_chunking(
        ...
        from agno_v2.knowledge.chunking.recursive import RecursiveChunking
    ...
    def _create_markdown_chunking(
        ...
        from agno_v2.knowledge.chunking.markdown import MarkdownChunking
