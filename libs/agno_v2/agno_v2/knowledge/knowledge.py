...
from agno_v2.knowledge.reader import Reader, ReaderFactory
from agno_v2.knowledge.remote_content.remote_content import GCSContent, RemoteContent, S3Content
...
class Knowledge:
    ...
    def __post_init__(self):
        from agno_v2.vectordb import VectorDb
    ...
    async def _load_from_s3(self, content: Content, upsert: bool, skip_if_exists: bool):
        ...
        """
        from agno_v2.cloud.aws.s3.object import S3Object
