...
class ReaderFactory:
    ...
    def _get_pdf_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.pdf_reader import PDFReader
    ...
    def _get_csv_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.csv_reader import CSVReader
    ...
    def _get_field_labeled_csv_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.field_labeled_csv_reader import FieldLabeledCSVReader
    ...
    def _get_docx_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.docx_reader import DocxReader
    ...
    def _get_pptx_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.pptx_reader import PPTXReader
    ...
    def _get_json_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.json_reader import JSONReader
    ...
    def _get_markdown_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.markdown_reader import MarkdownReader
    ...
    def _get_website_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.website_reader import WebsiteReader
    ...
    def _get_firecrawl_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.firecrawl_reader import FirecrawlReader
    ...
    def _get_tavily_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.tavily_reader import TavilyReader
    ...
    def _get_youtube_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.youtube_reader import YouTubeReader
    ...
    def _get_arxiv_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.arxiv_reader import ArxivReader
    ...
    def _get_wikipedia_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.wikipedia_reader import WikipediaReader
    ...
    def _get_web_search_reader(cls, **kwargs) -> Reader:
        ...
        from agno_v2.knowledge.reader.web_search_reader import WebSearchReader
