...
from agno_v2.exceptions import EvalError
from agno_v2.models.base import Model
from agno_v2.team.team import Team
from agno_v2.utils.log import log_error, logger, set_log_level_to_debug, set_log_level_to_info
...
""",
    ...
    def run(
        ...
        *,
        ...
        if self.telemetry:
            from agno_v2.api.evals import EvalRunCreate, create_eval_run_telemetry
    ...
    async def arun(
        ...
        *,
        ...
        if self.telemetry:
            from agno_v2.api.evals import EvalRunCreate, async_create_eval_run_telemetry
